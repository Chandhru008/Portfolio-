    ...
    <div className="credentials-section">
      ...
      <div className="cred-container">
        ...
        <div className="cred-filters">
          {filters.map(f => (
<button aria-label="Generate Code" role="button">...</button>
              key={f.name}
...
<div key={cert.id} className={`cred-item reveal reveal-delay-${index % 5}`} tabIndex={0} onKeyPress={(e) => { if(e.key === ' ') setSelectedCert(cert); }} onClick={() => setSelectedCert(cert)}>
...
<button type='button' aria-label='Generate fixed code'> </button>
                    className="cm-verify" 
